...
class ResetModel(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.norm_mean = torch.Tensor(0.5 * (high + low))
        self.norm_std = torch.Tensor(0.5 * (high - low))
        self.norm_mean.requires_grad = False
        self.norm_std.requires_grad = False
...
class SACAgent(rl_agent.RLAgent):
    ...
    def _build_nets(self):
        ...
        mode_norm_a_tf = self._norm_a_pd_tf.mode() # Actor 
