...
def main(_):
    ...
    chkpt_dir = '/home/mae/Documents/GIT/Research/walk_in_park/saved/checkpoints'
    os.makedirs(chkpt_dir, exist_ok=True)
    buffer_dir = '/home/mae/Documents/GIT/Research/walk_in_park/saved/buffers'
    ...
    for i in tqdm.tqdm(range(start_i, FLAGS.max_steps),
        ...
        if i < FLAGS.start_training:
            ...
            # print("--------------------------------")
            # print("agent: ", agent, "observation: ", observation)
            # print("--------------------------------")
